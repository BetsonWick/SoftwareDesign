...
@Controller
@RequestMapping("${openapi.eventSourcing.base-path:}")
public class TurnstileApiController implements TurnstileApi {

    private final NativeWebRequest request;

    @Autowired
    public TurnstileApiController(NativeWebRequest request) {
